...
import { Menu, X, Home, Users, BookOpen, FileText, BarChart2, Settings, LogOut } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectGroup,
...
export default function MobileNav() {
  ...
  return (
    <div className="md:hidden flex items-center justify-between bg-[#1F2937] text-white p-4">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent side="left" className="p-0 bg-[#1F2937] text-white">
          <div className="flex flex-col h-full">
            <div className="p-4 flex items-center justify-between">
              ...
              <Button variant="ghost" className="p-0 text-white" onClick={() => setOpen(false)}>
                <X className="h-6 w-6" />
              </Button>
            </div>
